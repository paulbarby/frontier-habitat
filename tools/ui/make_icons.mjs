...
const icons = {
  ...
  // ---------------------------------------------------------------- version 3: hazards, maintenance, research packs
  meteor: EO(circ(8.2, 15.8, 5.4) + circ(6.6, 14.6, 1.3) + circ(9.8, 17.6, 0.9)) + S('M11.8 12.2 20.5 3.5', 2.2) + S('M14.2 15.2l6.8-6.8M8.8 9.8l6.8-6.8', 1.8, S2),
  dust: S('M2.5 7.5c3-2 6 2 9.5 0s6.5 2 9.5 0M2.5 12.5c3-2 6 2 9.5 0s6.5 2 9.5 0', 2) + C(5.5, 17.6, 1.4, S2) + C(10.8, 18.4, 1.1, S2) + C(15.6, 17.2, 1.5, S2) + C(19.6, 18.8, 1, S2),
  quake: S('M2 12.5h3.6l2-6 3.2 12 3-9.2 2 5.2 1.6-2h4.6', 2) + R(2, 19.5, 20, 2, 1, S2),
  flare: C(12, 14.5, 5.2) + S('M6.6 9.6C6.1 3.6 17.9 3.6 17.4 9.6', 2.2) + rays(12, 14.5, 7.4, 9.6, 10, 1.6, S2, 18),
  dust_devil: S('M3 4.5h18', 2.2) + S('M5 8.7h14', 2.2, 0.85) + S('M7.2 12.9h10', 2.2, 0.7) + S('M9.4 17.1h5.6', 2.2, 0.55) + S('M11 21h2.6', 2.2, S2),
  wrench: P(WRENCH),
  shelter: P('M2.5 19.5a9.5 9.5 0 0 1 19 0z', S2) + C(12, 12.2, 2.1) + P('M8.8 19.5a3.2 3.4 0 0 1 6.4 0z') + R(1.5, 19.5, 21, 2, 1),
  turret: R(5.5, 17.5, 13, 4, 1.2) + P('M7.6 17.5a4.4 4.4 0 0 1 8.8 0z') + S('M12 13.4 18.4 6', 2.6) + CS(19.6, 4.4, 2.2, 1.6, S2),
  breach: EO(rrect(2.5, 2.5, 11, 19, 2) + poly([[8.6, 4.5], [6.4, 9], [9.2, 11], [6.6, 15.2], [8.8, 19.5], [10.4, 19.5], [8.6, 15.2], [11.2, 11], [8.6, 9], [10.2, 4.5]])) + S('M16 8.5h5.5M16 12h6M16 15.5h5', 1.8, S2),
  pack_basic: RS(4.5, 3.5, 15, 18, 3, 2) + R(8, 1.2, 8, 3.4, 1.2) + R(4.5, 15, 15, 3.2, 0, S2) + C(12, 9.6, 2.6),
  pack_applied: RS(4.5, 3.5, 15, 18, 3, 2) + R(8, 1.2, 8, 3.4, 1.2) + R(4.5, 15, 15, 3.2, 0, S2) + C(9, 9.6, 2.2) + C(15, 9.6, 2.2),
  pack_exotic: RS(4.5, 3.5, 15, 18, 3, 2) + R(8, 1.2, 8, 3.4, 1.2) + R(4.5, 15, 15, 3.2, 0, S2) + P('M12 5.8l2.4 3.2-2.4 3.4-2.4-3.4z'),
  icat_science: P(FLASK_BODY, S2) + P(FLASK_LIQ),
  credits: EO(circ(12, 12, 9.8) + circ(12, 12, 7.6)) + C(12, 12, 7.6, S2) + EO(rrect(10.4, 6.2, 3.2, 11.6, 1.2)),
  hazard: EO('M10.3 3.4a2 2 0 0 1 3.4 0l8.3 14.4a2 2 0 0 1-1.7 3H3.7a2 2 0 0 1-1.7-3z' + circ(12, 14.4, 3.2)) + C(12, 14.4, 1.3),
};
